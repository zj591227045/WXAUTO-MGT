    ...
    async def _edit_platform_async(self, platform_id: str):
        ...
        try:
            ...
            if dialog.exec():
                ...
                if success:
                    logger.info(f"更新平台成功: {updated_data['name']} ({platform_id})")
                    ...
                    # 显示成功消息
                    QMessageBox.information(self, "成功", f"更新平台成功: {updated_data['name']}")
                else:
                    logger.error(f"更新平台失败: {updated_data['name']}")
                    QMessageBox.warning(self, "错误", f"更新平台失败: {updated_data['name']}")
