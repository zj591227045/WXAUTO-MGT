...
class SettingsDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        # 监听超时时间
        self.listener_timeout_spin = QSpinBox()
        self.listener_timeout_spin.setRange(1, 1440)
        self.listener_timeout_spin.setValue(30)
        self.listener_timeout_spin.setSuffix(" 分钟")
        message_layout.addRow("监听超时:", self.listener_timeout_spin)
